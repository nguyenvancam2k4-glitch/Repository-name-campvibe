      ...
      <header className="fixed left-0 top-0 z-50 w-full border-b border-white/10 bg-stone-950/85 shadow-2xl shadow-black/10 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
          <Link to="/" className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-emerald-400 text-xl font-black text-stone-950 shadow-lg shadow-emerald-400/20">
              C
            </div>
          ...
          <Link
            to="/register"
            className="rounded-full bg-emerald-400 px-6 py-3 text-sm font-black text-stone-950 shadow-lg shadow-emerald-400/20 transition hover:bg-emerald-300"
          >
            Đăng ký
          </Link>
        </div>
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-10 py-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <section>
            ...
            <h1 className="camp-page-title text-4xl font-black leading-tight tracking-tight sm:text-5xl md:text-[3.9rem]">
              Quay lại CampVibe và tiếp tục hành trình
            </h1>
            <p className="mt-6 max-w-3xl text-lg leading-8 text-stone-400">
              Sau khi đăng nhập, bạn sẽ được chuyển
              vào trang tài khoản để xem hồ sơ và lịch sử đặt phòng của bạn.
            </p>

            <div className="mt-10 rounded-[2rem] border border-emerald-300/20 bg-emerald-300/10 p-6">
              <p className="text-sm font-bold uppercase tracking-[0.35em] text-emerald-300">
                Gợi ý nhanh
              </p>
              <p className="mt-4 leading-7 text-stone-300">
                Hãy dùng email và mật khẩu bạn đã đăng ký. Nếu chưa có tài khoản, bạn có thể tạo tài khoản mới chỉ trong vài giây.

              </p>
            </div>
          </section>

          <section className="rounded-[2.5rem] border border-white/10 bg-white/[0.07] p-6 shadow-2xl shadow-black/30 backdrop-blur md:p-9">
            <div className="mb-8">
              ...
              <h2 className="mt-6 text-4xl font-black">Đăng nhập</h2>
              <p className="mt-3 text-stone-400">
                Nhập email và mật khẩu để tiếp tục quản lý chuyến đi của bạn.
              </p>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-stone-500">
              Chưa có tài khoản?{" "}
              <Link to="/register" className="font-black text-emerald-300 hover:text-emerald-200">
                Đăng ký ngay
              </Link>
            </p>

            <div className="mt-5 text-center">
              <Link to="/admin-login" className="text-xs font-bold uppercase tracking-[0.25em] text-stone-600 hover:text-emerald-300">
                Đăng nhập Admin
              </Link>
            </div>
          </section>
